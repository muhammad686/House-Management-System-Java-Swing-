...
public class AllotmentForm extends JFrame implements ActionListener
{
	JPanel p,p1,p2;
	...
	AllotmentForm()
	{
		...
		date = new JLabel("Last Date");			      			tdate = new JTextField();
		pn = new JLabel("Rent");					tpn = new JTextField();
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(text_adv == "Submit")
		{
			try
			{
		         ...
		         String ds=     tdes.getText();  
		         String ct=     tctpe.getText();  
				 String ld=   tdate.getText();  
				...
				PreparedStatement stm_all = con_all.prepareStatement("insert into Allotments(FullName,Desg,CT,LD,AptNo,Rent)values(?,?,?,?,?,?)");
				
				stm_all.setString(1, n);
				stm_all.setString(2, ds);
				stm_all.setString(3, ct);
				stm_all.setString(4, ld);
				stm_all.setString(5, ano);
				stm_all.setString(6, pn);
