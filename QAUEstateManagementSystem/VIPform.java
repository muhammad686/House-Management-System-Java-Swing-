...
public class VIPform extends JFrame implements ActionListener
{
	JPanel p,p1,p2;
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(text_adv == "Submit")
		{
			try
			{
				...
				PreparedStatement stm_all = con_all.prepareStatement("insert into ColonyVIP(AptNo,ResName,AllotDate,Scale,Desg,Dept)values(?,?,?,?,?,?)");
